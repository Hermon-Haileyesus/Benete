...
const translations = [
  ...
  "TP16Title": "Suihkutunnistin",
  "TP16Intro": "Asennetaan suihkun vesiputkeen seuraamaan veden käyttöä ja peseytymiseen liittyvää toimintaa.",
  ...
  "ideologySection5P2": "With our service, it is possible to identify functional and memory-related disorders as early as possible and start the necessary treatment measures as early as possible.",
   ...
   //support
  "supportHeader": "BeneCare",
  "supportIntro": "Need help? Our support team ensures the smooth operation of the Benete service every day.",
  "supportTitle": "Support Videos",
  "supportSubtitle": "Watch instructional videos to learn how to use the BeneCare service and solve common issues.",
  "PIR1Title": "Motion Sensor",
  "PIR1Intro": "Installed above the door frame to monitor movement in the room. Enables reliable presence and activity detection.",
  "PIR2Title": "Area Sensor",
  "PIR2Intro": "Installed on the ceiling to detect movement across a wide area and provide comprehensive room monitoring.",
  "RouterTitle": "Router",
  "RouterIntro": "Ensures smooth connection and reliable operation of all sensors. Recommended to be placed near a power outlet.",
  "AM6Title": "Device Sensor",
  "AM6Intro": "Attached to the surface of a household appliance to monitor usage and habits.",
  "AR1Title": "Door Sensor",
  "AR1Intro": "Installed on the door and frame so that the distance between parts is no more than 1 cm. Detects door opening and closing as well as entries and exits.",
  "TP16Title": "Shower Sensor",
  "TP16Intro": "Installed on the shower pipe to monitor water usage and bathing activity.",
  "SafetyBraceletTitle": "Safety Bracelet",
  "SafetyBraceletIntro": "Comfortably worn on the wrist. Pressing the red button sends an alert to a predefined contact in case of emergency.",
  "SleepMonitorTitle": "Sleep Monitor",
  "SleepMonitorIntro": "Placed under the mattress at chest level. Measures sleep duration and rest. Recommended to be placed near a power outlet.",
  "SmartScaleTitle": "Smart Scale",
  "SmartScaleIntro": "Used on a flat and stable surface. Measures weight and supports continuous health monitoring.",
  "supportHelp": "Need more help?",
  "supportHelpDescription": "If you cannot find the answer in the videos, please contact us.",
 ...
 //support
  "supportHeader": "BeneCare",
  "supportIntro": "Behöver du hjälp? Vårt supportteam säkerställer att Benete-tjänsten fungerar smidigt varje dag.",
  "supportTitle": "Supportvideor",
  "supportSubtitle": "Se instruktionsvideor för att lära dig använda BeneCare-tjänsten och lösa vanliga problem.",
  "PIR1Title": "Rörelsesensor",
  "PIR1Intro": "Monteras ovanför dörrkarmen för att övervaka rörelser i rummet. Möjliggör tillförlitlig närvaro- och aktivitetsdetektering.",
  "PIR2Title": "Areasensor",
  "PIR2Intro": "Monteras i taket för att upptäcka rörelser över ett stort område och ge omfattande rumsövervakning.",
  "RouterTitle": "Router",
  "RouterIntro": "Säkerställer smidig anslutning och tillförlitlig funktion för alla sensorer. Rekommenderas att placeras nära ett eluttag.",
  "AM6Title": "Enhetssensor",
  "AM6Intro": "Fästs på ytan av en hushållsapparat för att övervaka användning och vanor.",
  "AR1Title": "Dörrsensor",
  "AR1Intro": "Monteras på dörren och karmen så att avståndet mellan delarna är högst 1 cm. Upptäcker dörröppning och stängning samt in- och utpasseringar.",
  "TP16Title": "Duschsensor",
  "TP16Intro": "Monteras på duschröret för att övervaka vattenanvändning och duschaktivitet.",
  "SafetyBraceletTitle": "Trygghetsarmband",
  "SafetyBraceletIntro": "Bärs bekvämt på handleden. Genom att trycka på den röda knappen skickas ett larm till en fördefinierad kontakt vid nödsituation.",
  "SleepMonitorTitle": "Sömnmonitor",
  "SleepMonitorIntro": "Placeras under madrassen vid brösthöjd. Mäter sömnens längd och vila. Rekommenderas att placeras nära ett eluttag.",
  "SmartScaleTitle": "Smart våg",
  "SmartScaleIntro": "Används på en plan och stabil yta. Mäter vikt och stödjer kontinuerlig hälsouppföljning.",
  "supportHelp": "Behöver du mer hjälp?",
  "supportHelpDescription": "Om du inte hittar svaret i videorna, kontakta oss.",
