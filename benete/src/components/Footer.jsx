  ...
  return (
    <section className="footer">
      <div className='footer-b1'>
        {/* Company Info */}
        <div>
          <h5 className="footer-title">{t("contactCompany")}</h5>
          <a
          ...
          >
            <p className="footer-text">{t("contactAddress1")}</p>
            <p className="footer-text">{t("contactAddress2")}</p>
            <p className="footer-text">{t("contactFloor")}</p>
          </a>
        </div>

        <div>
          <h5 className="footer-title">{t("navContact")}</h5>
          <p className="footer-text">{t("contactCeo")}</p>
          <p className="footer-text">{t("contactPhone")}</p>
          <p className="footer-text">
            <a className='footer-link' href={`mailto:${t("contactEmail")}`}> {t("contactEmail")}</a>
          </p>
        </div>

        <div>
          <h5 className="footer-title">{t("footerFollowUs")}</h5>
      ...
      <div className="footer-b2">
        <div>
          <h5>
            <Link to="/privacy-policy" className="footerB2-link">{t("footerPrivacy")}</Link>
            &nbsp;&amp;&nbsp;
            <Link to="/terms" className="footerB2-link">{t("footerTerms")}</Link>
          </h5>
        </div>
      </div>
    </section>
